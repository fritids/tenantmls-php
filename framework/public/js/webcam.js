...
window.webcam = {
	...
	swf_url: TenantMLS.BASE_PATH+'/src/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: TenantMLS.BASE_PATH+'/src/shutter.mp3', // URI to shutter.mp3 sound
