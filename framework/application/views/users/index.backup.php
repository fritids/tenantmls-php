        ...
        <div id="ui-mainPage-body">		
            <div id="ui-mainPage-search">
                <form action="/users/signup" method="post">
                    ...
                    <div id="ui-mainpage-form-container">
                    	<table>
                    		<tr>
                    			<td>I want a</td>
                    			<td>
                    				<div id="ui-form-bedrooms">
                    		...
                    		<tr>
                    			<td>in</td>
                    			<td>
                    				<div class="ui-form-select-styled">
				                    	<select name="locale-state" id="inactive" class="ui-mainpage-select-locale">
					                        <?php
					                ...
					                <div class="ui-form-select-styled">
		                    		<select name="locale-state" class="ui-mainpage-select-locale">
		                    			<?php
				                        $str = '';
