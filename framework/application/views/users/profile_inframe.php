...
END;
		...
		<div id="tmls-ui-profile-header">
			<div class="tmls-ui-body-highlight" id="highlight-profile">
				<ul id="tmls-profile-navigation">
					<li id="selected"><span id="dropdown-arrow"></span><a class="p" href="<?php echo BASE_PATH.'/dashboard'; ?>">Dashboard</a></li>
					<li><a class="p" href="<?php echo BASE_PATH.'/users/profile/'.$profile['User']['tmls_number']; ?>">About</a></li>
					<li>Tenants</li>
					<li>Contact</li>
					<li>Reviews</li>
				</ul>
